function downloadAsPDF() {
  var HTML_Width = $(".htmlContent").width();
  var HTML_Height = $(".htmlContent").height();
  ...
  html2canvas($(".htmlContent").get(0)).then(function (canvas) {
    var imgData = canvas.toDataURL("image/jpeg", 1.0);
    var pdf = new jsPDF("p", "pt", [PDF_Width, PDF_Height]);
    pdf.addImage(canvas, top_left_margin, top_left_margin);
